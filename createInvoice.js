...
function generateHeader(doc) {
    doc
        ...
        .fillColor("#444444")
        .fontSize(10)
        .text("Viettel Construction", 200, 50, { align: "right" })
        .text("So 06 Pham Van Bach", 200, 65, { align: "right" })
        .text("Phuong Yen Bach, Quan Cau Giay Ha Noi", 200, 80, { align: "right" })
        .moveDown();
}
...
function generateTableRow(
    ...
    doc
        ...
        .text(unitCost, 460, y, { width: 90, align: "right" })
}
